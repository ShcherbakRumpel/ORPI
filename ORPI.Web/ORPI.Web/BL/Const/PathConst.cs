...
namespace ORPI.Web.BL.Const
{
    public static class PathConst
    {
        ...
        public static String TXTFILEPATH = @"D:\Other\OrpiProject\temp";//use another path
        public static String SOURCE = @"D:\Other\OrpiProject\OPRI\ORPI\ORPI.Web\ORPI.Web\";  //use another path
