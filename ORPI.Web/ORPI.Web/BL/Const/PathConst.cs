...
namespace ORPI.Web.BL.Const
{
    public static class PathConst
    {
        ...
        public static String TXTFILEPATH = @"D:\Other\OrpiProject\temp1";//use another path
        public static String SOURCE = @"D:\Other\OrpiProject\ORPI\ORPI.Web\ORPI.Web\";  //use another path
